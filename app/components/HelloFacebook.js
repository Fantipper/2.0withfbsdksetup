    ...
    return (
      ...
      {/*   2nd the fantip style   */}
        ...
        <FontAwesome.Button 
            ...
            >
          <Text style={styles.fblogBtnText}>CONTINUE WITH FACEBOOK</Text>
        </FontAwesome.Button>
        </View>
        
        <TouchableOpacity onPress={this.facebookLogin} style={styles.fblogbtn}>
          {/*<FontAwesome name='facebook-square' size={32} />*/}
          <FontAwesome name="facebook-square" size={24} color='#3b5998'>
          <Text>Continue with Facebook</Text></FontAwesome>
        </TouchableOpacity>
        <TouchableHighlight
          style={styles.share}
